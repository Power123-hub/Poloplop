    ...
    try {
      ...
      await tempmsg.channel.awaitMessages(m=>m.author.id == message.author.id, {
        ...
        .then(async collected => {
          ...
          if(channel){
            ...
            return message.reply(new Discord.MessageEmbed()
              .setTitle(`<a:yes:833101995723194437> The Channel: \`${channel.name}\` is now registered as the Auto Nsfw Poster Channel`)
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          ...
          return message.reply(new Discord.MessageEmbed()
            .setTitle(`<a:yes:833101995723194437> Disabled the Auto Nsfw Poster Channel`)
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<a:yes:833101995723194437> Settings of the Auto Nsfw Poster Channel`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
